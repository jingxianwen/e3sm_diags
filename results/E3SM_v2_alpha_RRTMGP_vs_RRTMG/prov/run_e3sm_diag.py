...
param.reference_data_path = '/global/cscratch1/sd/xianwen/E3SM_simulations/E3SM_v2_alpha_AMIP_RRTMG.ne30_ne30.cori-knl/archive/climo/'
#param.reference_name = 'E3SM_v2_alpha_AMIP_RRTMGP.ne30_ne30.cori-knl' #match output file name
param.reference_title = 'RRTMG'# will show on plots


#============= test =============
#param.test_data_path = '/global/project/projectdirs/acme/acme_diags/test_model_data_for_acme_diags/climatology/'
param.test_data_path = '/global/cscratch1/sd/xianwen/E3SM_simulations/E3SM_v2_alpha_AMIP_RRTMGP.ne30_ne30.cori-knl/archive/climo/'
param.test_name = 'E3SM_v2_alpha_AMIP_RRTMGP.ne30_ne30.cori-knl' #match output file name
param.test_title = 'RRTMGP'# will show on plots (central upper)
param.short_test_name = ' '# will show on plots (central left)

#============= difference =============
param.diff_name = "RRTMGP_RRTMG"
param.diff_title = "RRTMGP-RRTMG"

#prefix = '/compyfs/www/zhan429/doc_examples/'
prefix = '/global/cscratch1/sd/xianwen/e3sm_diags/results/'
param.results_dir = os.path.join(prefix, 'E3SM_v2_alpha_RRTMGP_vs_RRTMG')
