...
param.test_data_path = '/global/cscratch1/sd/xianwen/acme_scratch/cori-knl/E3SMv2_modified_iceflag3_noEmis/climo/'
param.test_name = 'E3SMv2_modified_iceflag3_noEmis' #match output file name
param.test_title = 'modified(iceflag3)'# will show on plots (central upper)
param.short_test_name = ' '# will show on plots (central left)

#============= difference =============
param.diff_name = "modified_iceflag3-Standard"
param.diff_title = "modified(iceflag3)-Standard"

#prefix = '/compyfs/www/zhan429/doc_examples/'
prefix = '/global/cscratch1/sd/xianwen/e3sm_diags/results/'
param.results_dir = os.path.join(prefix, 'E3SMv2_UMRad_iceflag3_noEmis_vs_standard')
